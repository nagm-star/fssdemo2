                ...
                <div class="pagination-arrow">
                        ...
                        <a href="{{ route('post.single', ['slug' => $prev->slug ]) }}" class="btn-next-wrap">
                            <div class="btn-content">
                                ...
                                <p class="btn-content-subtitle"> {!!  substr(strip_tags($prev->title), 0, 20) !!}</p>
                            </div>
                            <svg class="btn-next">
                    ...
                    @if ($next)
                            <a href="{{ route('post.single', ['slug' => $next->slug ]) }}" class="btn-prev-wrap">
                                ...
                                <div class="btn-content">
                                    ...
                                    <p class="btn-content-subtitle">{!!  substr(strip_tags($next->title), 0, 20) !!}</p>
                                </div>
                            </a>
                    @endif
